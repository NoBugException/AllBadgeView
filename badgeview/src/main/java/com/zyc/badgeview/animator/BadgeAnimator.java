package com.zyc.badgeview.animator;
...
public class BadgeAnimator extends ValueAnimator {
    ...
    private WeakReference<AllBadgeView> mWeakBadge;

    public BadgeAnimator(Bitmap badgeBitmap, PointF center, AllBadgeView badge) {
        ...
        addUpdateListener(new AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                AllBadgeView badgeView = mWeakBadge.get();
