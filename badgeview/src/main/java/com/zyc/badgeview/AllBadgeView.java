...
import com.zyc.badgeview.animator.BadgeAnimator;
import com.zyc.badgeview.utils.DisplayUtil;
import com.zyc.badgeview.utils.MathUtil;

import java.util.ArrayList;
import java.util.List;

public class AllBadgeView extends View implements AllBadge {
    ...
    public AllBadgeView(Context context) {
        this(context, null);
    }

    private AllBadgeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    private AllBadgeView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @Override
    public AllBadge bindTarget(final View targetView) {
        if (targetView == null) {
     ...
     */
    @Override
    public AllBadge setBadgeNumber(int badgeNumber) {
    ...
    @Override
    public AllBadge setBadgeText(String badgeText) {
    ...
    @Override
    public AllBadge setExactMode(boolean isExact) {
        mExact = isExact;
        if (mBadgeNumber > 99) {
    ...
    @Override
    public AllBadge setShowShadow(boolean showShadow) {
    ...
    @Override
    public AllBadge setBadgeBackgroundColor(int color) {
    ...
    @Override
    public AllBadge stroke(int color, float width, boolean isDpValue) {
    ...
    @Override
    public AllBadge setBadgeBackground(Drawable drawable) {
        return setBadgeBackground(drawable, false);
    }

    @Override
    public AllBadge setBadgeBackground(Drawable drawable, boolean clip) {
    ...
    @Override
    public AllBadge setBadgeTextColor(int color) {
    ...
    @Override
    public AllBadge setBadgeTextSize(float size, boolean isSpValue) {
    ...
    @Override
    public AllBadge setBadgePadding(float padding, boolean isDpValue) {
     ...
     */
    @Override
    public AllBadge setBadgeGravity(int gravity) {
    ...
    @Override
    public AllBadge setGravityOffset(float offset, boolean isDpValue) {
        return setGravityOffset(offset, offset, isDpValue);
    }

    @Override
    public AllBadge setGravityOffset(float offsetX, float offsetY, boolean isDpValue) {
    ...
    @Override
    public AllBadge setOnDragStateChangedListener(OnDragStateChangedListener l) {
        mDraggable = l != null;
    ...
    private class BadgeContainer extends ViewGroup {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                View child = getChildAt(i);
                if (!(child instanceof AllBadgeView)) {
                    targetView = child;
                } else {
                    badgeView = child;
                }
